...
static void skin_load(UISkin* skin, const uint8_t* data, const uint8_t* end)
{
...
{
    skin_load(&g_skins[SKIN_GLYPHBORN],
        _binary_data_ui_skins_default_gbskin_start,
        _binary_data_ui_skins_default_gbskin_end);
